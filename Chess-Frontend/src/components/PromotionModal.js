...
export default function PromotionModal({ promo, onPick }) {
  ...
  return (
    <div className="cm-fade-in" style={{ position: "fixed", inset: 0, background: "rgba(6,4,2,0.8)", backdropFilter: "blur(3px)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 999 }}>
          ...
          {["Q", "R", "B", "N"].map((t, i) => (
            <div key={t} onClick={() => onPick(t)} className="cm-btn"
              ...
              <div style={{
                ...
                <PieceGlyph piece={promo.col + t} size={54} />
              </div>
